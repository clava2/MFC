...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_DESTROY:
        ...
        break;
	case WM_LBUTTONDOWN:
		MessageBox(NULL, L"郑聪", L"Tips", NULL);
		break;
	case WM_KEYDOWN:
		if (wParam == 0x41)
		{
			MessageBox(NULL, L"按下a键！", L"tips", NULL);
		}
...
{
	MessageBox(NULL, L"线程函数已经调用！", L"Tips", MB_ABORTRETRYIGNORE | MB_OK);
	_endthread();
}